...
use Taxjar\SalesTax\Model\ResourceModel\Job\Collection as JobCollection;
...
class Queue extends AbstractModel
{
    ...
    public function jobExists($hash)
    {
        ...
        $item = $collection->clear()->getFirstItem();
        return (!$item->isEmpty());
    }
    ...
    {
        $maxJobs = $this->scopeConfig->getValue('taxjar/salestax/queue/max_jobs');
